  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case RBACRolesRow:
            return RBACRolesRow(data);
          case ProgramsRow:
            return ProgramsRow(data);
          case CodeCategoriesRow:
            return CodeCategoriesRow(data);
          case OrgCodesRow:
            return OrgCodesRow(data);
          case RegionsRow:
          ...
          case ProgCodesRow:
            return ProgCodesRow(data);
          case CodesRow:
            return CodesRow(data);
          default:
            return null;
        }
