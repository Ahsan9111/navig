...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF066367);
  late Color secondary = const Color(0xFFE5A443);
  late Color tertiary = const Color(0xFF0C4876);
  ...
  late Color primaryBackground = const Color(0xFFFAFCFC);
  ...
  late Color outline = const Color(0xFF6F797A);
  late Color primaryLight = const Color(0x15066367);
  late Color primaryLight2 = const Color(0xFFE2ECED);
  late Color primaryLight3 = const Color(0x28066367);
  late Color onSurfaceVariant = const Color(0xFF3F494A);
